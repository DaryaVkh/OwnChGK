    ...
    return (
        <PageWrapper>
            ...
            <div className={classes.contentWrapper}>
                <p className={classes.instructionsParagraph} style={{marginTop: '17vh', marginBottom: '2vh'}}>Для восстановления пароля введите E-mail, указанный при регистрации</p>
                <p className={classes.instructionsParagraph} style={{marginBottom: '8vh'}}>На него будет отправлен новый пароль</p>

                <div className={classes.form}>
                    <CustomInput type='email' placeholder='E-mail' name='email' id='email' style={{width: '65%'}} isInvalid={isEmailInvalid} />
                ...
                <div className={classes.linkToSignInWrapper} style={{justifyContent: isEmailInvalid ? 'space-between' : 'flex-end'}}>
                    {isEmailInvalid
                        ?
                        ...
                        : null}
                    <Link className={classes.linkToSignIn} to={props.isAdmin ? '/admin' : '/auth'}>Вспомнил пароль</Link>
                </div>
