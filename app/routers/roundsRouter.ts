...
export const roundsRouter = () => {
    ...
    router.patch('/:gameId/:number/change', roleMiddleware(adminAccess), roundsController.editRound);
    router.delete('/:gameId/:number', roleMiddleware(adminAccess), roundsController.deleteRound);
